...
const Home = () => {
  return (
    <div name = 'home' className = 'w-full h-full pt-[60px] bg-[#ffffff]'>
        ...
        */}
        <div className = 'max-w-[1920px] mx-auto lg:px-[70px] md:px-[50px] px-10 flex flex-col justify-center'>
          ...
          <p className = 'text-2xl text-[#000000]'>Hello, my name is</p>
          ...
          <div className = 'max-w-[170px]'>
            <Link to='work' smooth={true} duration={500}>
              <button className = 'text-black border-black group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#F8A218] hover:border-[#F8A218]'>
                  View Work
