...
const Work = () => {
  return (
    <div name = 'work' className='w-full h-full lg:px-[70px] md:px-[50px] p-10 text-black bg-[#186EF8]'>
      <div className=' w-full h-full max-w-[1920px] mx-auto py-4 flex flex-col justify-center'>
        ...
        {/* container for projects */}
          {/* Gird */}
        <div className='grid sm:grid-cols-1 md:grid-cols-2 gap-8 max-w-[1080px]'>
          ...
          <div style={{ backgroundImage: `url(${Minesweeper})` }} className="shadow-lg shadow-[#040c16] group container rounded-md 
            ...
            <div className='shadow-lg shadow-[#040c16] group container rounded-md 
              ...
              <div className='opacity-0 group-hover:opacity-100 content-div'>
                ...
                {/* Buttons */}
                <ReactPlayer width='100%' height ='69%' url={MinesweeperVideo} controls={true} />
          ...
          <div style={{ backgroundImage: `url(${Boomshine})` }} className="shadow-lg shadow-[#040c16] group container rounded-md 
              ...
              {/* Hover effect for images */}
              <div className='w-fit h-fit opacity-0 group-hover:opacity-100 content-div'>
                <span className='text-2xl font bold text-white tracking-wider'>
                  Android Boomshine
                </span>

                {/* Buttons */}
                <ReactPlayer width='100%' height ='69%' url={BoomshineVideo} controls={true} />
                <a href="https://github.com/timm6430/Boomshine" target="_blank" rel="noopener noreferrer">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
